          ...
          <div style={{ position: "relative" }}>
            <button
              ...
              style={{
                ...
                color: "#fff", fontFamily: "'Cairo',sans-serif", fontSize: 13, fontWeight: 800,
            ...
            {switcherOpen && (
              <>
                ...
                <div style={{
                  ...
                  background: "#331f42", border: `1px solid ${C.border}`, borderRadius: 10,
                  minWidth: 180, padding: 6, boxShadow: "0 12px 32px rgba(0,0,0,.32)",
                }}>
                  {siblings.map((p) => (
                    <button
                      key={p.id}
