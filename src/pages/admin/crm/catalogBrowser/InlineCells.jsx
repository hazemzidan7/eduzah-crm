  ...
  return (
    <select
      ...
      style={{
        ...
        background: color ? `${color}3d` : "rgba(255,255,255,.08)",
        border: `1px solid ${color ? color + "99" : C.border}`,
        color: "#fff", fontWeight: 800, fontSize: 11, letterSpacing: 0.2,
        borderRadius: 999, padding: "5px 22px 5px 10px",
