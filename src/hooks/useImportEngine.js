...
import { cleanPhone, cleanEmail, cleanWhitespace, cleanBoolean, cleanAttendanceType, splitMultiValue } from "../utils/importEngine/dataCleaning";
...
export function useImportEngine() {
  ...
  const cleanValueForField = (fieldKey, rawValue) => {
    ...
    if (fieldKey === "attendanceType") return cleanAttendanceType(rawValue);
